# Resmin tamamında ışık yoğunluğu yüksek veya tamamında ışık yoğunluğu düşük ise Global histogram kullanılabilir.
# Fakat resmin belli bölgelerinde ışık yoğunluğu düşükken belli bölgelerinde ışık yoğunluğu yüksek ise local histogram uygulaması daha uygun olur.
...
def local_enhancement(img,c,k0,k1,k2,k3,window_size):
    ...
    for satir in range(M):
        ...
        for sutun in range(N):
          ...
          window_r = img[ust_index:alt_index,sol_index:sag_index] # cercevenin olusmasi
...
img= cv2.imread("./images/01.png",0)
